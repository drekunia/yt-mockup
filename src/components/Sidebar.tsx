...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`w-56 lg:sticky absolute top-0 overflow-y-auto scrollbar-hidden pb-4 flex-col ml-1 gap-2 px-2 ${
          isLargeOpen ? "lg:flex" : "lg:hidden"
        } ${isSmallOpen ? "flex z-[999] bg-white max-h-screen" : "hidden"}`}
      >
        <div className="lg:hidden sticky top-0 bg-white pt-2 pb-4 px-2">
        ...
        <LargeSidebarSection title="Explore">
          ...
          <LargeSidebarItem
            ...
            url="/gaming"
          />
          <LargeSidebarItem IconOrImgUrl={Camera} title="Live" url="/live" />
